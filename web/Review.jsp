<%-- 
    Document   : Review
    Created on : Aug 8, 2023, 5:58:23 PM
...
<%
    if (request.getParameter("submit") != null) {
        try {
            ...
            String sql = "insert into review(Name,Email,Comment) values(?,?,?)";
            ...
            <div class="container py-5">
                <div class="row d-flex justify-content-center">
                    <div class="col-md-10 col-xl-8 text-center">
                        <h3 class="fw-bold mb-4">COUSTOMER REVIEW</h3>
                        <p class="mb-4 pb-2 mb-md-5 pb-md-0" >
                            we believe in the power of shared culinary experiences. This is the space where our vibrant community of home cooks, food enthusiasts, and adventurous bakers come together to celebrate the art of cooking and baking. We understand that every recipe tells a unique story, and your experiences add a personal touch to the dishes we all love.
                        </p>
                    </div>
                </div>
                <div class="row text-center">
                    <div class="col-md-4 mb-4 mb-md-0">
                        <div class="card" >
                            <div class="card-body py-4 mt-2" style="background-color: #FFFFFF;">
                                ...
                                <p class="mb-2">
                                    <i class="fas fa-quote-left pe-2"></i>These cookies are amazing! I followed the recipe exactly, and they turned out soft and chewy on the inside with a perfect crispy edge. My whole family loved them! 
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-4 mb-md-0">
                        <div class="card">
                            <div class="card-body py-4 mt-2 " style="background-color: #FFFFFF;">
                                ...
                                <p class="mb-2">
                                    <i class="fas fa-quote-left pe-2"></i>Great recipe, but I reduced the sugar a bit and they were still delicious. Next time, I might add a touch of sea salt on top for a sweet-salty contrast.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-0">
                        <div class="card">
                            <div class="card-body py-4 mt-2" style="background-color: #FFFFFF;">
                                ...
                                <p class="mb-2">
                                    <i class="fas fa-quote-left pe-2"></i>As someone who's not very confident in the kitchen, I found this recipe easy to follow. My cookies didn't turn out as perfect as in the picture, but they tasted great!
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="wrapper wrapper--w960">
                <div class="card card-2">
                    ...
                    <div class="card-body body_card">
                        <h2 class="title">PUT YOUR REVIEW COMMENTS</h2>
                        <form action="" method="POST">
                            <div class="input-group">
                                <input class="input--style-2" type="text" placeholder="Your Name" name="Uname">
                            </div>
                            <div class="input-group">
                                <input class="input--style-2" type="email" placeholder="Email Address" name="Email">
                            </div>
                            <div class="input-group">
                                <input class="input--style-2" type="text" placeholder="Comments" name="comment">
                            </div>
                            <div class="p-t-30">
...
<footer class="text-center bg-dark" style="background: linear-gradient(90deg, rgb(11, 36, 71), rgb(165, 215, 232));">
    <div class="container text-white py-4 py-lg-5">
        ...
        <p class=" mb-0 text-white ">Copyright © 2023</p>
    </div>
</footer>
</body>
