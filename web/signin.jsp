    ...
    <body
        ...
        <div>
            ...
            <div
                ...
                >
                <div style="text-align: center">
                    <img src="assets/img/logo-no-background.png" style="width: 250px" />
                </div>
                <p class="profile-name-card"></p>
                <form class="form-signin" action="signin_backend.jsp" method="POST">
                    ...
                    <button
                        class="btn btn-primary btn-lg d-block btn-signin w-100 btn-d"
                        type="submit"
                ...
                <div class="row">
                    <div
                        class="col"
                        style="border-style: none; border-color: var(--bs-secondary-color)"
                        >
                        <a class="forgot-password" href="register.jsp">Create Account...</a>
                    </div>
                </div>
            </div>
        ...
        <div id="footer">
            ...
            <footer
                ...
                <div class="container text-white py-4 py-lg-5">
                    ...
                    <p class="text-muted mb-0" style="color: var(--bs-body-bg)">
                        Copyright © 2023
                    </p>
                </div>
            </footer>
