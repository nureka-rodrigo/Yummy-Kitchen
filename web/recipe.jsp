<%-- 
    Document   : recipe
    Created on : Aug 2, 2023, 3:29:03 PM
    Author     : TUF
--%>
...
<%
    ...
    User user = new User();
    ResultSet rs = user.getAllRecipes();
...
<html data-bs-theme="light" lang="en">
    ...
    <body>
                ...
                <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span><img
                    ...
                    <div class="collapse navbar-collapse" id="navcol-5">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="recipe.jsp">Recipes</a></li>
        ...
        <div id="heading" class="heading-bgnd"
            ...
            <h1 style="text-align: center;color: rgb(217,245,255);margin: 0px;padding: 6px;padding-top: 60px; padding-bottom: 60px">Yummy Kitchen All Recipes</h1>
        </div>
