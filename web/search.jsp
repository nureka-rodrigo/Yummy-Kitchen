<%-- 
    Document   : search
    Created on : Aug 2, 2023, 3:14:46 PM
    Author     : TUF
--%>
...
<%
    String recipe_name = request.getParameter("recipe-name");

    User user = new User();
    ResultSet rs = user.searchRecipes(recipe_name);
%>
<!DOCTYPE html>
            ...
            <div style="padding: 25px;"><!-- Start: cards -->
                <div class="row" data-masonry="{&quot;percentPosition&quot;: true }"><!-- Start: card-1 -->
                    ...
                    <div class="col-sm-6 col-lg-4 mb-4"><!-- Start: card -->
                        <div class="card">
                            <picture type="" srcset=""><img class="card-img-top p-3" src="<% out.print(rs.getString("Image"));  %>" alt=""
