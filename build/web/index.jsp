<%-- 
    Document   : index
    Created on : Aug 2, 2023, 12:12:38 AM
    Author     : TUF
--%>
...
<%
    User user = new User();
    ResultSet rs = user.getFirstFiveRecipes();
%>
<!DOCTYPE html>
<html data-bs-theme="light" lang="en">
    ...
    <body>
        ...
        <div id="heading" class="heading-bgnd"
             style="background: url(&quot;assets/img/ingredients-cooking-preparation-spices.jpg&quot;) center / cover no-repeat;">
            <h1 style="text-align: center;color: rgb(217,245,255);margin: 0px;padding: 6px;padding-top: 40px;">Yummy Kitchen
                Recipes</h1>
            <h6 style="text-align: center;color: rgb(217,245,255);padding: 5px;">Find your all favorite food recipes here...
            </h6>
            <div id="search-bar-area">
                <form class="d-flex justify-content-center flex-wrap my-2" method="post" action="search.jsp" style="padding-bottom: 20px;">
                    <div class="my-2"><input class="form-control" type="text" name="recipe-name"
                                             placeholder="Type Recipe Name....."></div>
                    <div class="my-2"><button class="btn btn-primary ms-sm-2 btn1" type="submit"
                                              style="border-style: none;padding-left: 12px;margin-left: 7px;">Search</button></div>
                </form>
            </div>
        </div>
        <div id="recipe-area"><!-- Start: Masonry gallery cards responsive -->
            <div style="padding: 25px;"><!-- Start: cards -->
                <div class="row" data-masonry="{&quot;percentPosition&quot;: true }"><!-- Start: card-1 -->
                    <%                        while (rs.next()) {
                    %>
                    <div class="col-sm-6 col-lg-4 mb-4"><!-- Start: card -->
                        <div class="card">
                            <picture type="" srcset=""><img class="card-img-top p-3" src="assets/img/<% out.print(rs.getString("Image"));  %>" alt=""
                                                            style="border-radius: 24px; object-fit: cover"></picture><!-- Start: texto -->
                            <div class="card-body" style="text-align: center;">
                                <h5 class="card-title"><% out.print(rs.getString("Title"));  %></h5>
                                <form action="showrecipe.jsp" method="POST">
                                    <input type="hidden" name="r-name" value="<% out.print(rs.getString("Title"));  %>">
                                    <button class="btn btn-primary ms-sm-2 btn1" type="submit"style="border-style: none;">Show Recipe</button>
                                </form>
