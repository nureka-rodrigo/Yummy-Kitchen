...
<html data-bs-theme="light" lang="en">
    ...
    <body
        style="
        background: url('assets/img/ingredients-cooking-preparation-spices.jpg')
        ...
        <div>
            <div
                ...
                >
                <div
                    class="col-sm-12 col-lg-10 col-xl-9 col-xxl-7 reg"
                    style="border-radius: 5px; background: var(--bs-focus-ring-color)"
                    >
                    <div class="p-5">
                        <div></div>
                        ...
                        <!-- Start: Register Form -->
                        <form class="user" action="register_backend.jsp" method="POST">
                            <!-- Start: Username -->
                            <div class="mb-3">
                                <input
                            ...
                            <!-- End: Password --><!-- Start: Password -->

                            <!-- End: Password --><!-- Start: Email Error Message -->
                            <div class="row mb-3">
                                <p id="emailErrorMsg" class="text-danger" style="display: none">
                                    Paragraph
                                </p>
                                <p
                                    id="passwordErrorMsg"
                            ...
                            <!-- End: Email Error Message --><button
                                class="btn btn-primary d-block btn-user w-100 reg-btn"
                                id="submitBtn"
                                type="submit"
                                value="Register"
                        ...
                        <!-- End: Forgot Password -->
                        <div style="text-align: center">
                            <a class="forgot-password" href="signin.jsp" style="font-size: 14px"
