<%-- 
    Document   : contact_us
    Created on : Aug 5, 2023, 12:40:04 PM
    Author     : Asus
--%>
    ...
    <body>
        <nav class="navbar navbar-expand-md bg-dark py-3" data-bs-theme="dark"
            ...
            <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span><img
                            src="assets/img/logo-no-background.png" style="width: 5rem;height: 3rem;"></span></a>
                ...
                <div class="collapse navbar-collapse" id="navcol-5">
                    ...
                    <a class="btn text-white p-2 px-3 fs-6 m-3 mt-2 btn1 shadow-none" role="button" href="signin.jsp"
                       style="border-style: none;">Login</a>
                </div>
            </div>
        </nav>
                            ...
                            <div class="row no-gutters">
                                <div class="col-md-7 d-flex align-items-stretch">
                                    <div class="contact-wrap w-100 p-md-5 p-4">
                                        ...
                                        <form action="contact-us_backend.jsp" method="POST" id="contactForm" name="contactForm">
                                            <div class="row">
                                                <div class="col-md-6">
                                ...
                                <div class="col-md-5 d-flex align-items-stretch">
                                    <div class="info-wrap bg-primary w-100 p-lg-5 p-4">
                                        ...
                                        <div class="dbox w-100 d-flex align-items-start">
                                            ...
                                            <div class="text pl-3">
                                                <p><span>Address:</span> No:32B, 2nd mile post, Passara Road Badulla</p>
                                            </div>
                                        </div>
                                        <div class="dbox w-100 d-flex align-items-center">
                                            ...
                                            <div class="text pl-3">
                                                <p><span>Phone:</span> <a href="tel://+94912254666">+94912254666</a></p>
                                            </div>
                                        </div>
                                        <div class="dbox w-100 d-flex align-items-center">
                                            <div class="icon d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="text pl-3">
                                                <p><span>Email:</span> <a href="mailto: yammykitchen@gmail.com">yummykitchen@gmail.com</a></p>
                                            </div>
                                        </div>
                                        <div class="dbox w-100 d-flex align-items-center">
                                            <div class="icon d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="text pl-3">
                                                <p><span>Website</span> <a href="index.html">yummykitchen.com</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
